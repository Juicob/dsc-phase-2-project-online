...
<table>
    <tr>
        <td style="width:300px; height:300px; text-align:center; vertical-align:middle">
<img src='https://i.imgur.com/mBKpFBg.png' width="100%" height="100%">
        </td>
        <td style="width:300px; height:300px; text-align:center; vertical-align:middle">
<img src='https://i.imgur.com/zF4xI39.png' width="100%" height="100%">
        </td>
        <td style="width:300px; height:300px; text-align:center; vertical-align:middle">
<img src='https://i.imgur.com/ihJZdZW.png' width="100%" height="100%">
        </td>
    </tr>
</table>
